<script type="text/javascript">
    $(document).ready(function() {
        ...
        load_graphHcImportPrincipalProd("{{ $id_div }}", {{ $xprod }}, {{ $gestion_ini }}, {{ $gestion_fin }}, {{ $ames }}, fil);
    });
    
    function load_graphHcImportPrincipalProd(iddiv, xprod, gestion_ini, gestion_fin, ames, filtros){
        ...
        $.ajax({
            url: "{{ route('graph.importPrinProd') }}",
