<script type="text/javascript">
    $(document).ready(function() {
        ...
        load_graphHcExportSector("{{ $id_div }}", {{ $xprod }}, {{ $gestion_ini }}, {{ $gestion_fin }}, {{ $ames }}, fil);
    });
	
    function load_graphHcExportSector(iddiv, xprod, gestion_ini, gestion_fin, ames, filtros){
